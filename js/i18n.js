...
const translations = {
  ...
  en: {
    ...
    backup: {
      ...
      keyNotesDesc:       'A separate, connected space for anything more sensitive — protected by its own PIN or password, independent from Dash Notes.',
  ...
  fr: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Un espace séparé et connecté pour tout ce qui est plus sensible — protégé par son propre code PIN ou mot de passe, indépendant de Dash Notes.',
  ...
  de: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Ein separater, verbundener Bereich für alles Sensiblere — geschützt durch eine eigene PIN oder ein Passwort, unabhängig von Dash Notes.',
  ...
  el: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Ένας ξεχωριστός, συνδεδεμένος χώρος για ό,τι είναι πιο ευαίσθητο — προστατευμένος με δικό του PIN ή κωδικό πρόσβασης, ανεξάρτητος από το Dash Notes.',
  ...
  pt: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Um espaço separado e conectado para tudo o que for mais sensível — protegido pelo seu próprio PIN ou palavra-passe, independente do Dash Notes.',
