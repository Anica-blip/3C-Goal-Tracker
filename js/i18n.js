...
const translations = {
  ...
  en: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'A separate, connected space for anything more sensitive — protected by its own PIN, passphrase, and password together, independent from Dash Notes.',
      keyNotesBtn:        'Open KEY Notes',
  ...
  fr: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Un espace séparé et connecté pour tout ce qui est plus sensible — protégé par son propre code PIN, sa phrase secrète et son mot de passe, indépendant de Dash Notes.',
      keyNotesBtn:        'Ouvrir KEY Notes',
  ...
  de: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Ein separater, verbundener Bereich für alles Sensiblere — geschützt durch eigene PIN, Passphrase und Passwort zusammen, unabhängig von Dash Notes.',
      keyNotesBtn:        'KEY Notes öffnen',
  ...
  el: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Ένας ξεχωριστός, συνδεδεμένος χώρος για ό,τι είναι πιο ευαίσθητο — προστατευμένος με δικό του PIN, φράση πρόσβασης και κωδικό πρόσβασης μαζί, ανεξάρτητος από το Dash Notes.',
      keyNotesBtn:        'Άνοιγμα KEY Notes',
  ...
  pt: {
    ...
    backup: {
      ...
      keyNotesTitle:      '🔑 KEY Notes',
      keyNotesDesc:       'Um espaço separado e conectado para tudo o que for mais sensível — protegido pelo seu próprio PIN, frase-passe e palavra-passe, independente do Dash Notes.',
      keyNotesBtn:        'Abrir KEY Notes',
